(function ($) {
    ...
    function Scroller(elem, settings) {
        ...
        that.show = function (prevAnim) {
            ...
            var arr1 = s.wheels[0],
                arr2 = s.wheels[1],
                obj1 = Object.assign(arr1, arr2),
                weekDay = ["周日", "周一", "周二", "周三", "周四", "周五", "周六"],
                myDate = new Date(),
                weekStr = weekDay[myDate.getDay()],
                dataTxt = myDate.getFullYear() +'年' + (myDate.getMonth() + 1) + '月' + myDate.getDate() + '日' + '&nbsp&nbsp' + weekStr;
            // Create wheels containers
            var html = '<div class="dw-trans ' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg ' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr"><div class="clearfix"><div class="dwbw dwb-s"><span class="dwb" >' + s.setText + '</span></div><h2 id="choseData">'+ dataTxt +'</h2><div class="dwbw dwb-c"><span class="dwb">' + s.cancelText + '</span></div></div>' + (s.headerText ? '' : ''));
            ...
            if (s.display != 'inline') {
                ...
                that.tap($('.dwb-c span, .dwo', dw), function () {
                    that.cancel();
                });
    ...
    $(document).bind(END_EVENT, function (e) {
        ...
        if (move) {
            ...
            setTimeout(function () {
                var dateStr = $('.dw-sel .dw-i').eq(0).text() + '/' + $('.dw-sel .dw-i').eq(1).text() + '/' + $('.dw-sel .dw-i').eq(2).text(),
                    dateStr_text = $('.dw-sel .dw-i').eq(0).text() + '年' + $('.dw-sel .dw-i').eq(1).text() + '月' + $('.dw-sel .dw-i').eq(2).text() +'日',
                    myDate = new Date(Date.parse(dateStr)),
                    weekStr = weekDay[myDate.getDay()];
                choseObj.html(dateStr_text + '&nbsp&nbsp' + weekStr);
            },10)
