...
$(function () {
    var r = {
        ...
        footer: '<div class="mPicker-footer"><a href="javascript:;" class="mPicker-cancel">取消</a><a href="javascript:;" class="mPicker-confirm">确定</a></div>',
        confirm: function () {},
        cancel: function () {}
    };
    var h;
    ...
    v.prototype = {
        ...
        render: function () {
            ...
            A = q.call(D, E);
            // H = '<div class="mPicker-main ' + D.disy + '" data-pickerId="' + D.pickerId + '">' + D.options.header +
            H = '<div class="mPicker-main ' + D.disy + '" data-pickerId="' + D.pickerId + '">' + D.options.footer +
                '<div class="mPicker-content">' + A + '</div><div class="mPicker-shadow"></div>' +
                "</div>";
            D.mpicker.append(H);
        ...
        confirm: function () {
            ...
            if(A.options.valueSpace){ //扩展
                var valArr = [];
                valArr = y.split(' ');
                A.container.val(valArr[0]);
            }else{
                A.container.val(y);
            }
        ...
        event: function () {
            var A = this;
            this.container.off("touchstart.container click.container").on("touchstart.container click.container", function (
                C) {
                C.preventDefault();
                C.stopPropagation();
                var B = $(this);
            ...
            this.mpicker.off("touchstart.confirm click.confirm").on("touchstart.confirm click.confirm",
                ".mPicker-confirm", function (B) {
                    B.preventDefault();
                    var C = $(".mPicker").data("object");
                    C.confirm()
                });
            this.mpicker.off("touchstart.cancel click.cancel").on("touchstart.cancel click.cancel", ".mPicker-cancel", function (
                B) {
                B.preventDefault();
                var C = $(".mPicker").data("object");
                C.cancel()
            });
            this.mpicker.off("touchstart.mask click.mask").on("touchstart.mask click.mask", ".mPicker-mask", function (
                B) {
                B.preventDefault();
                var C = $(".mPicker").data("object");
                if (C.options.shadow) {
            ...
            var x;
            var z;
            this.mpicker.off("touchstart.list mousedown.list").on("touchstart.list mousedown.list", ".mPicker-list", function (
                B) {
                g(B);
                var D = $(this).find("ul");
                var C = a(D);
            ...
            this.mpicker.off("touchmove.list mousemove.list").on("touchmove.list mousemove.list", ".mPicker-list", function (
                E) {
                E.preventDefault();
                if (!h) {
                    return false
    ...
    function b(B, C) {
        ...
        var z = typeof (C) === "number" ? B.find("li").index(B.find('li[data-id="' + C + '"]')) : this.middleRowIndex -
            D;
        var A = -this.options.height * (z - this.middleRowIndex);
        m(B, A);
        B.find("li").eq(z).addClass("active").siblings("li").removeClass("active");
        x = {
